...
- [ereandel](https://github.com/blmayer/ereandel) (Shell) - terminal client written in POSIX shell script featuring a custom pager, bookmarks, history, customization and client certificates.
